...
import tournamentPDF from '../../assets/pdf/PGA.pdf'
...
const NewHeader = ({ isAuth }) => {
  ...
  const bogeytourlinks = [
    { label: 'Tour Schedule', path: '/tour-schedule' },
            ...
            <ul className={styles.backdrop_list}>
              ...
              {links[0].label === 'Events Booking' && (
                <li>
                  ...
                  <a
                    href='https://drive.google.com/file/d/1BlhW5V1yb-0pOVvWDYVfx2ObI8G7WGD7/view?usp=sharing'
                    target='_blank'
                  >
                    Tournament Info
                  </a>
